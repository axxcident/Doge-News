...
<template>
  ...
  <ul>
    <li>Webbanrop görs information från en eller flera webbtjänster visas i webbapplikationen (Undvik CORS-problem och
      ...
      En egen json fil med information går också bra som jag har demonstrerat och den bör innehålla minst 10st objekt
